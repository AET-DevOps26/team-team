...
public class BankingSyncService {
  ...
  public void syncAccount(BankingConnection connection) {
        ...
        for (Map<String, Object> tx : transactions) {
          ...
          String direction =
              "CRDT".equalsIgnoreCase(creditDebitIndicator)
                  ...
                  : "DEBIT";
          String category =
              tx.get("remittanceInformationUnstructured") != null
          ...
          List<Transaction> existing =
              transactionRepository.findByAccountIdAndCategoryAndAmountAndDirection(
          ...
          newTx.setCreatedAt(LocalDateTime.now(ZoneId.systemDefault()));
    ...
    log.info(
        "Synced account for connection {} (bank: {})",
        connection.getId(),
        connection.getBankName());
  }
